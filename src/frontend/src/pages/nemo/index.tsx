...
import { ArrowLeft, Database, Wrench, Activity, Settings, Save, AlertCircle } from "lucide-react";
  ...
  useEffect(() => {
    ...
    if (savedConfig) {
      try {
        ...
        setConfig(parsed);
        setIsConfigValid(parsed.baseUrl && parsed.authToken && parsed.namespace);
      } catch (error) {
      ...
      <div className="mb-6">
        ...
        {!isConfigValid && (
          <Alert variant="destructive" className="mt-4">
            ...
            <AlertDescription>
              Configuration required. Please click "Configure" to set up your NeMo microservices connection.
            </AlertDescription>
          </Alert>
        )}
      </div>
      ...
      {showConfig ? (
        <Card className="mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Configure your connection to NeMo microservices. These settings will be used for all API calls.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="flex space-x-2">
              <Button
                ...
                disabled={!config.baseUrl || !config.authToken || !config.namespace}
                className="flex items-center space-x-2"
              >
